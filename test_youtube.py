...
def infer2(model, postprocessors, device, output_path, dm):
    ...
    print_freq = 10
    for samples, _targets, image_id, *_ in metric_logger.log_every(data_loader_train, print_freq):
        ...
        #print(outputs.keys()) # pred_logits, pred_boxes, aux_outputs
        print(outputs["pred_logits"][1])
        print()
